...
### 1.1 Write and ship a Privacy Policy
...
### 1.2 Complete the Data Safety form
...
### 2.2 Signed release `.aab` CI pipeline
...
### 2.4 Verify the `CAMERA` permission's actual behavior
...
### 2.5 Document the version-bump convention
...
### 3.1 Remove dead `android:requestLegacyExternalStorage="true"`
...
### 3.2 Network security config (defense in depth)
...
### 3.3 Improve the Anthropic API key dialog disclosure
...
### 3.4 Server-side retention/deletion story
