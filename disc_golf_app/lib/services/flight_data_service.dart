...
class FlightDataService {
  ...
  static Future<String> loadFlightPath() async {
    try {
      return await rootBundle.loadString('assets/flight_data/output_coordinates.json');
    } catch (e) {
  ...
  static Future<Map<String, dynamic>> loadAnalysisResults() async {
    try {
      final String jsonString = await rootBundle.loadString('assets/flight_data/analysis_results.json');
